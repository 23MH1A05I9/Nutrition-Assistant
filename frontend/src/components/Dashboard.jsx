    ...
    <div className="content animate-in">
      <div className="page-header">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          ...
          <button className="btn btn-primary">📋 View Meal Plan</button>
        </div>
      </div>
      ...
      <div className="grid-2" style={{ marginBottom: 20 }}>
        <div className="card">
          <div className="card-header">
            ...
            <button className="btn btn-sm btn-secondary">View Plan</button>
          </div>
          {[
        ...
        <div className="card">
          ...
          <div className="grid-2" style={{ gap: 10 }}>
            {[
              ...
              <button key={q.label} className="btn btn-outline" style={{ justifyContent: 'center', flexDirection: 'column', height: 70, gap: 4 }}>
