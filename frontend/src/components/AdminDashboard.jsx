      ...
      <div className="grid-2" style={{ marginBottom: 20 }}>
        ...
        <div className="card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            {[
              { label: 'Approve pending dietitians', em: '✅', action: () => {} },
              { label: 'View all users', em: '👥', action: () => {} },
              { label: 'Manage appointments', em: '📅', action: () => {} },
              { label: 'Send notifications', em: '🔔', action: () => {} },
              { label: 'View analytics report', em: '📈', action: () => {} },
            ].map(a => (
              <button key={a.label} className="btn btn-outline" style={{ justifyContent: 'flex-start', gap: 10 }} onClick={a.action}>
